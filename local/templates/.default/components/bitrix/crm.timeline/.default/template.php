	...
	BX.ready(
		function()
		{
			...
			BX.CrmTimelineItem.messages =
			{
				...
				personalincomingCall: "<?=GetMessageJS('CRM_TIMELINE_INCOMING_PERSONAL_CALL_TITLE')?>",
				personaloutgoingCall: "<?=GetMessageJS('CRM_TIMELINE_OUTGOING_PERSONAL_CALL_TITLE')?>",


				corpincomingCall: "<?=GetMessageJS('CRM_TIMELINE_INCOMING_CORP_CALL_TITLE')?>",
				corpoutgoingCall: "<?=GetMessageJS('CRM_TIMELINE_OUTGOING_CORP_CALL_TITLE')?>",
