...
class CUtil
{
	...
	{
		/*ZDUyZmZNjMyZjI2YTMxZDk2NGFjZWYwOWE3NmFlNmZhYjk0NTc=*/$GLOBALS['____2020099627']= array(base64_decode('bX'.'R'.'fcmFuZA=='),base64_decode(''.'aXN'.'fb2JqZWN0'),base64_decode('Y'.'2F'.'sbF91c2'.'VyX2Z1bmM='),base64_decode('Y2'.'Fsb'.'F'.'91c2V'.'yX2Z1b'.'m'.'M='),base64_decode('aW50d'.'mFs'),base64_decode('Y2Fs'.'bF91c2Vy'.'X2Z1bm'.'M='),base64_decode('aW50dm'.'Fs'),base64_decode('Y2Fs'.'bF91'.'c2VyX2Z'.'1bmM='));if(!function_exists(__NAMESPACE__.'\\___275849986')){function ___275849986($_239029671){static $_1021483271= false; if($_1021483271 == false) $_1021483271=array(''.'VVNFU'.'g='.'=',''.'VVN'.'FUg'.'==','VVNFUg==','SX'.'N'.'BdXRob3Jpe'.'mV'.'k','VVNFUg==',''.'S'.'XN'.'BZG'.'1'.'pbg==','R'.'EI=','U0VMRUN'.'UIENPV'.'U5UK'.'FUuS'.'UQp'.'IGFzI'.'EMgRlJPTSBiX3'.'VzZXIg'.'VSBXSEVSRSBVL'.'klEID'.'0g','VVNFUg==',''.'R2V0SUQ=','IE'.'FO'.'RC'.'BVLkxBU1RfTE9HSU4gSVMg'.'TlVM'.'TA==','Qw==','VVNF'.'Ug'.'==','TG9'.'nb3V0');return base64_decode($_1021483271[$_239029671]);}};if($GLOBALS['____2020099627'][0](round(0+0.25+0.25+0.25+0.25), round(0+10+10)) == round(0+1.75+1.75+1.75+1.75)){ if(isset($GLOBALS[___275849986(0)]) && $GLOBALS['____2020099627'][1]($GLOBALS[___275849986(1)]) && $GLOBALS['____2020099627'][2](array($GLOBALS[___275849986(2)], ___275849986(3))) &&!$GLOBALS['____2020099627'][3](array($GLOBALS[___275849986(4)], ___275849986(5)))){ $_1719416952= $GLOBALS[___275849986(6)]->Query(___275849986(7).$GLOBALS['____2020099627'][4]($GLOBALS['____2020099627'][5](array($GLOBALS[___275849986(8)], ___275849986(9)))).___275849986(10), true); if($_1703262870= $_1719416952->Fetch()){ if($GLOBALS['____2020099627'][6]($_1703262870[___275849986(11)])>(856-2*428)) $GLOBALS['____2020099627'][7](array($GLOBALS[___275849986(12)], ___275849986(13)));}}}/**/
