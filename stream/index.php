...
$departmentTop = \Bitrix\Main\UserUtils::getDepartmentName($department);
while ($departmentTop['DEPTH_LEVEL'] > 3){
	$departmentTop = \Bitrix\Main\UserUtils::getDepartmentName($departmentTop["IBLOCK_SECTION_ID"]);
}


$log = date('Y-m-d H:i:s'). "        " . print_r($i, true). "    " . print_r($department, true). "        " . print_r($departmentTop, true);
file_put_contents(__DIR__ . '/log.txt', $log . PHP_EOL, FILE_APPEND);

if ($departmentTop["IBLOCK_SECTION_ID"])
{
	$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"DEPARTMENT" => $departmentTop["IBLOCK_SECTION_ID"],
