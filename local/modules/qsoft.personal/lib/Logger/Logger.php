...
{
    protected const EMPTY_CHANNEL = 'empty';
    ...
    {
        return self::channel(self::EMPTY_CHANNEL);
    }
    ...
    protected function __construct(?string $channel = null, ?int $level = null)
    {
        ...
        $stream = new RotatingFileHandler($this->getFilePath(), 7, $level);
    ...
    {
        if ($this->channel === self::EMPTY_CHANNEL) {
            return;
        }
