...
$MESS["INTRANET_USER_PROFILE_BLOG_POST_MODIFY"] = "изменить";
$MESS["INTRANET_USER_PROFILE_BLOG_POST_STUB_TEXT"] = "Делитесь интересными историями из жизни, или просто расскажите о себе, загружайте фотографии памятных моментов.";
$MESS["INTRANET_USER_PROFILE_BLOG_POST_STUB_BUTTON"] = "Рассказать о себе";
$MESS["INTRANET_USER_PROFILE_INTERESTS_STUB_TEXT"] = "Создавайте интересы или присоединяйтесь к уже существующим. Найдите друзей, разделяющих ваши увлечения.";
$MESS["INTRANET_USER_PROFILE_INTERESTS_STUB_BUTTON"] = "Рассказать о моих интересах";
$MESS["INTRANET_USER_PROFILE_INTERESTS_STUB_BUTTON_2"] = "Выбрать интересы";
$MESS["INTRANET_USER_PROFILE_BLOG_GRAT_TITLE"] = "Благодарности";
...
$MESS["INTRANET_USER_PROFILE_employee"] = "Действия";
$MESS["INTRANET_USER_PROFILE_ADD_PHOTO"] = "Изменить фотографию";
$MESS["INTRANET_USER_PROFILE_FIELD_SUBORDINATE"] = "Подчиненные";
$MESS["INTRANET_USER_PROFILE_FIELD_MANAGERS"] = "Руководитель";
$MESS["INTRANET_USER_PROFILE_CHAT"] = "Чат";
$MESS["INTRANET_USER_PROFILE_VIDEOCALL"] = "Видеозвонок";
$MESS["INTRANET_USER_PROFILE_AVATAR_CAMERA"] = "Сделать фото";
$MESS["INTRANET_USER_PROFILE_AVATAR_LOAD"] = "Загрузить фото";
$MESS["INTRANET_USER_PROFILE_LAST_SEEN_IDLE_M"] = "Нет на месте с #LAST_SEEN#";
$MESS["INTRANET_USER_PROFILE_LAST_SEEN_IDLE_F"] = "Нет на месте с #LAST_SEEN#";
...
$MESS["INTRANET_USER_PROFILE_SECURITY"] = "Безопасность";
$MESS["INTRANET_USER_PROFILE_REINVITE"] = "Пригласить ещё раз";
$MESS["INTRANET_USER_PROFILE_DELETE"] = "Удалить";
$MESS["INTRANET_USER_PROFILE_FIRE"] = "Уволить";
$MESS["INTRANET_USER_PROFILE_HIRE"] = "Принять на работу";
$MESS["INTRANET_USER_PROFILE_MOVE_TO_INTRANET"] = "Перевести в интранет";
$MESS["INTRANET_USER_PROFILE_MOVE"] = "Перевести";
$MESS["INTRANET_USER_PROFILE_MOVE_TO_INTRANET_TITLE"] = "Перевести в интранет";
$MESS["INTRANET_USER_PROFILE_RIGHTS"] = "Права";
$MESS["INTRANET_USER_PROFILE_ADMIN_MODE"] = "Режим администратора";
$MESS["INTRANET_USER_PROFILE_QUIT_ADMIN_MODE"] = "Выйти из режима администратора";
$MESS["INTRANET_USER_PROFILE_SET_ADMIN_RIGHTS"] = "Дать права администратора";
$MESS["INTRANET_USER_PROFILE_REMOVE_ADMIN_RIGHTS"] = "Забрать права администратора";
$MESS["INTRANET_USER_PROFILE_SYNCHRONIZE"] = "Синхронизация";
$MESS["INTRANET_USER_PROFILE_TAGS_TITLE"] = "Мои интересы";
$MESS["INTRANET_USER_PROFILE_TAGS_MODIFY"] = "изменить";
$MESS["INTRANET_USER_PROFILE_TAGS_POPUP_ADD"] = "Добавить себе интерес";
$MESS["INTRANET_USER_PROFILE_TAGS_POPUP_TITLE"] = "Популярные теги:";
...
$MESS["INTRANET_USER_PROFILE_FIRE_CONFIRM"] = "Сотрудник больше не сможет зайти на портал, не появится в структуре компании, но все его данные (файлы, сообщения, задачи и т.п.) сохранятся.
<br/><br/>
...
$MESS["INTRANET_USER_PROFILE_DELETE_CONFIRM"] = "Вы уверены, что хотите удалить приглашенного пользователя?";
$MESS["INTRANET_USER_PROFILE_YES"] = "Да";
$MESS["INTRANET_USER_PROFILE_NO"] = "Нет";
$MESS["INTRANET_USER_PROFILE_SAVE"] = "Сохранить";
$MESS["INTRANET_USER_PROFILE_CLOSE"] = "Закрыть";
$MESS["INTRANET_USER_PROFILE_REINVITE_SUCCESS"] = "Приглашение было отправлено";
...
$MESS["INTRANET_USER_PROFILE_RIGHTS_RESTR_TEXT2"] = "Назначение большего количества администраторов позволит сразу нескольким пользователям иметь полный доступ ко всем инструментам, управлять телефонией и открытыми линиями, а также следить за настройками вашего Битрикс24! Количество администраторов зависит от тарифа:";
$MESS["INTRANET_USER_PROFILE_RIGHTS_RESTR_MORE"] = "Узнать подробнее";
$MESS["INTRANET_USER_PROFILE_TARIFF_PROJECT"] = "Проект";
$MESS["INTRANET_USER_PROFILE_TARIFF_TF"] = "Проект+";
$MESS["INTRANET_USER_PROFILE_TARIFF_TEAM"] = "Команда";
$MESS["INTRANET_USER_PROFILE_TARIFF_COMPANY"] = "Компания";
$MESS["INTRANET_USER_PROFILE_UNLIM"] = "неограниченно";
...
<br/><br/>
Сотрудник #NAME# получит полные права доступа, за исключением возможности приглашать или увольнять администраторов. 
Вы уверены, что хотите дать права Интегратора этому сотруднику?
";
